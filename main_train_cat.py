...
import data_generator_poisson3 as dg
from data_generator_poisson3 import DenoisingDataset
...
save_dir = os.path.join('models', 'cat_peak40_tao1_decay0.95_eta0.1_lam0.1_1055_epo2')
...
class PADMM(nn.Module):
    def __init__(self,tao=1,eta=0.1,decay=0.95, level=10, subnet=5, n_channels=64, image_channels=1):
...
if __name__ == '__main__':
    ...
    scheduler = MultiStepLR(optimizer, milestones=[3,5], gamma=0.2)  # learning rates
